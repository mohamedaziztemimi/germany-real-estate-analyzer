...
export const translations: Record<Language, Record<TranslationKeys, string>> = {
  ...
  de: {
    ...
    heroTitle: "Intelligenz für Immobilieninvestitionen in Deutschland",
    heroSubtitle:
    ...
    feature1Description: "Erhalte in Sekunden eine Einschätzung von Rendite, Cap Rate und Wert nach der Sanierung.",
    feature2Title: "Marktorientierte Einschätzung",
    ...
    feature3Description: "Klare Empfehlung mit den wichtigsten Gründen, warum sich ein Kauf lohnt oder nicht.",
    ...
    analysisEmpty: "Fülle das Formular aus und starte die Analyse, um Ergebnisse zu sehen.",
